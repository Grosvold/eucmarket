...
async def answer_q6(message: types.Message, state: FSMContext):
    ...
    if len(photos) > 0:
        ...
        album.attach_photo(photo=photos[0], caption=adtext)
        for a in photos[1:]:
